...
def GetTheInput_Single():
    ...
    #MyRawData = pd.read_csv(r"D:\Users\Mike\Desktop\New folder (5)\New folder (7)\DeepLearning\PredictCandlestick\BinaryClassification_DenseLayer\EURUSD_5M_times2.csv") 
